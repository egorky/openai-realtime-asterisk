...
- Cuando la conversación haya concluido y el usuario no tenga más preguntas, DEBES usar la herramienta endCall para finalizar la llamada. No llames a endCall hasta que el usuario confirme que no necesita nada más.
